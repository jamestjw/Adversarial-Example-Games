...
python no_box_attack.py --dataset mnist --namestr="B Mnist eps=0.3 Extragradient PGD-Critic=True Lambda=10 Training-set=test" --perturb_loss Linf --epsilon=0.3 --attack_ball Linf --batch_size 1024 --test_batch_size 64 --attack_epochs 150 --extragradient --lr 1e-3 --lr_model 1e-3 --max_iter 20 --attack_loss cross_entropy --model CondGen --command train --source_arch ens_adv --model_name modelB --type 1 --eval_freq 2 --transfer --lambda_on_clean 10 --save_model "modelB-pgd-critic-test" --dir_test_models ../ --adv_models modelA modelB modelC modelD modelA_ens modelB_ens modelC_ens modelD_ens --wandb --pgd_on_critic --train_set test

python no_box_attack.py --dataset mnist --namestr="C Mnist eps=0.3 Extragradient PGD-Critic=True Lambda=10 Training-set=test" --perturb_loss Linf --epsilon=0.3 --attack_ball Linf --batch_size 1024 --test_batch_size 64 --attack_epochs 150 --extragradient --lr 1e-3 --lr_model 1e-3 --max_iter 20 --attack_loss cross_entropy --model CondGen --command train --source_arch ens_adv --model_name modelC --type 2 --eval_freq 2 --transfer --lambda_on_clean 10 --save_model "modelC-pgd-critic-test" --dir_test_models ../ --adv_models modelA modelB modelC modelD modelA_ens modelB_ens modelC_ens modelD_ens --wandb --pgd_on_critic --train_set test


python no_box_attack.py --dataset mnist --namestr="D Mnist eps=0.3 Extragradient PGD-Critic=True Lambda=10 Training-set=test" --perturb_loss Linf --epsilon=0.3 --attack_ball Linf --batch_size 1024 --test_batch_size 64 --attack_epochs 150 --extragradient --lr 1e-3 --lr_model 1e-3 --max_iter 20 --attack_loss cross_entropy --model CondGen --command train --source_arch ens_adv --model_name modelD --type 3 --eval_freq 2 --transfer --lambda_on_clean 10 --save_model "modelD-pgd-critic-test" --dir_test_models ../ --adv_models modelA modelB modelC modelD modelA_ens modelB_ens modelC_ens modelD_ens --wandb --pgd_on_critic --train_set test
